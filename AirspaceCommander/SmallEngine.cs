//-----------------------------------------------------------------------
// <copyright file="SmallEngine.cs" company="Tallyrald">
...
namespace Airspace_Commander
{
    ...
    /// </summary>
    internal class SmallEngine : IEngine
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Airspace_Commander.SmallEngine" /> class.
        /// </summary>
        ...
        public SmallEngine(string newName, double extraSpeed, double extraSr)
        {
            name = newName;
            speed = 10 + extraSpeed;
            speedRate = 0 + extraSr;
