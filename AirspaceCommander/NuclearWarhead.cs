//-----------------------------------------------------------------------
// <copyright file="NuclearWarhead.cs" company="Tallyrald">
...
namespace Airspace_Commander
{
    ...
    /// </summary>
    internal class NuclearWarhead : IWarhead
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Airspace_Commander.NuclearWarhead" /> class.
        /// </summary>
        ...
        public NuclearWarhead(string newName, int extraDmg, int extraRadius)
        {
            name = newName;
            damage = 1 + extraDmg;
            radius = 30000 + extraRadius;
        }
