//-----------------------------------------------------------------------
// <copyright file="SmallWarhead.cs" company="Tallyrald">
...
namespace Airspace_Commander
{
    ...
    /// </summary>
    internal class SmallWarhead : IWarhead
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Airspace_Commander.SmallWarhead" /> class.
        /// </summary>
        ...
        public SmallWarhead(string newName, int extraDmg, int extraRadius)
        {
            name = newName;
            damage = 1 + extraDmg;
            radius = 30 + extraRadius;
        }
