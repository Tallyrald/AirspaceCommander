//-----------------------------------------------------------------------
// <copyright file="MediumWarhead.cs" company="Tallyrald">
...
namespace Airspace_Commander
{
    ...
    /// </summary>
    internal class MediumWarhead : IWarhead
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Airspace_Commander.MediumWarhead" /> class.
        /// </summary>
        ...
        public MediumWarhead(string newName, int extraDmg, int extraRadius)
        {
            name = newName;
            damage = 1 + extraDmg;
            radius = 40 + extraRadius;
        }
